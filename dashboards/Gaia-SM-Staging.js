...
var gaiaserveElbName = 'GaiaSM-Staging-ELB1';
var aqsamplesElbName = 'GaiaSM-Staging-AqSamples-ELB';
var ec2Instance1Id = 'i-0e8b69dd';
var ec2Machine1 = 'GaiaSM-Staging-Node1-us-east-1a';
var ec2Instance2Id = 'i-70d392d9';
var ec2Machine2 = 'GaiaSM-Staging-Node2-us-east-1d';
var rdsInstanceId = 'gaiastagingdb';
...
var metrics = [
    {	target: 'gaiaserve ELB.HealthyHost Min(cnt)',
        Namespace: 'AWS/ELB', 'MetricName': 'HealthyHostCount',
        link: getElbHealthyCountLink(gaiaserveElbName),
        warning: 1, critical: 0,
        Statistics: ['Minimum'],
        Dimensions: [
            {Name: 'LoadBalancerName', Value: gaiaserveElbName}
        ] },
    {	target: 'gaiaserve ELB.Requests Sum(cnt)',
        Namespace: 'AWS/ELB', 'MetricName': 'RequestCount',
        link: getElbRequestCountLink(gaiaserveElbName),
        Statistics: ['Sum'],
        Dimensions: [
            {Name: 'LoadBalancerName', Value: gaiaserveElbName}
        ] },
    { 	target: 'gaiaserve ELB.Latency Avg(s)',
        Namespace: 'AWS/ELB', MetricName: 'Latency',
        link: getElbLatencyLink(gaiaserveElbName),
        Statistics: ['Average'],
        Dimensions: [
            {Name: 'LoadBalancerName', Value: gaiaserveElbName}
        ] },
    {	target: 'aqsamples ELB.HealthyHost Min(cnt)',
        Namespace: 'AWS/ELB', 'MetricName': 'HealthyHostCount',
        link: getElbHealthyCountLink(aqsamplesElbName),
        warning: 1, critical: 0,
        Statistics: ['Minimum'],
        Dimensions: [
            {Name: 'LoadBalancerName', Value: aqsamplesElbName}
        ] },
    {	target: 'aqsamples ELB.Requests Sum(cnt)',
        Namespace: 'AWS/ELB', 'MetricName': 'RequestCount',
        link: getElbRequestCountLink(aqsamplesElbName),
        Statistics: ['Sum'],
        Dimensions: [
            {Name: 'LoadBalancerName', Value: aqsamplesElbName}
        ] },
    { 	target: 'aqsamples ELB.Latency Avg(s)',
        Namespace: 'AWS/ELB', MetricName: 'Latency',
        link: getElbLatencyLink(aqsamplesElbName),
        Statistics: ['Average'],
        Dimensions: [
            {Name: 'LoadBalancerName', Value: aqsamplesElbName}
        ] },
